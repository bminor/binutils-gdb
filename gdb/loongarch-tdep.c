  ...
  if ((feature = tdesc_find_feature (tdesc, "org.gnu.gdb.loongarch.fpu")))
    {
      ...
      valid_p &=
        tdesc_numbered_register (feature, tdesc_data.get (), regnum++, "fcc0");
      valid_p &=
        tdesc_numbered_register (feature, tdesc_data.get (), regnum++, "fcc1");
      valid_p &=
        tdesc_numbered_register (feature, tdesc_data.get (), regnum++, "fcc2");
      valid_p &=
        tdesc_numbered_register (feature, tdesc_data.get (), regnum++, "fcc3");
      valid_p &=
        tdesc_numbered_register (feature, tdesc_data.get (), regnum++, "fcc4");
      valid_p &=
        tdesc_numbered_register (feature, tdesc_data.get (), regnum++, "fcc5");
      valid_p &=
        tdesc_numbered_register (feature, tdesc_data.get (), regnum++, "fcc6");
      valid_p &=
        tdesc_numbered_register (feature, tdesc_data.get (), regnum++, "fcc7");
      valid_p &= tdesc_numbered_register (feature, tdesc_data.get (),
