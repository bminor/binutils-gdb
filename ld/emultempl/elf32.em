				   ...
				   int constraint)
{
  ...
  if (link_info.type == type_executable
...
echo '  ; else if (link_info.type == type_executable' >> e${EMULATION_NAME}.c
echo '             && link_info.pic' >> e${EMULATION_NAME}.c
...
echo '  ; else if (link_info.type == type_executable' >> e${EMULATION_NAME}.c
echo '             && link_info.pic) return' >> e${EMULATION_NAME}.c
sed $sc ldscripts/${EMULATION_NAME}.xd			>> e${EMULATION_NAME}.c
fi
if test -n "$GENERATE_SHLIB_SCRIPT" ; then
if test -n "$GENERATE_COMBRELOC_SCRIPT" ; then
echo '  ; else if (link_info.type == type_dll && link_info.combreloc' >> e${EMULATION_NAME}.c
echo '             && link_info.relro' >> e${EMULATION_NAME}.c
echo '             && (link_info.flags & DF_BIND_NOW)) return' >> e${EMULATION_NAME}.c
sed $sc ldscripts/${EMULATION_NAME}.xsw			>> e${EMULATION_NAME}.c
echo '  ; else if (link_info.type == type_dll && link_info.combreloc) return' >> e${EMULATION_NAME}.c
sed $sc ldscripts/${EMULATION_NAME}.xsc			>> e${EMULATION_NAME}.c
fi
echo '  ; else if (link_info.type == type_dll) return'	>> e${EMULATION_NAME}.c
...
if test -n "$GENERATE_COMBRELOC_SCRIPT" ; then
fragment <<EOF
  else if (link_info.type == type_executable
	   && link_info.pic
	   && link_info.combreloc
	   && link_info.relro
...
fragment <<EOF
  else if (link_info.type == type_executable && link_info.pic)
...
if test -n "$GENERATE_COMBRELOC_SCRIPT" ; then
fragment <<EOF
  else if (link_info.type == type_dll && link_info.combreloc
...
fragment <<EOF
  else if (link_info.type == type_dll)
