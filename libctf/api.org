...
int ctf_add_member_bitfield (ctf_dict_t *, ctf_id_t souid,
                             ...
                             int bit_width);
ctf_id_t ctf_add_datasec (ctf_dict_t *, uint32_t flag, const char *);
ctf_id_t ctf_add_section_variable (ctf_dict_t *, const char *, const char *,
...
int ctf_func_type_arg_names (ctf_dict_t *, ctf_id_t, uint32_t,
                             const char **);
int ctf_type_linkage (ctf_dict_t *, ctf_id_t, ctf_linkage_t *);
ctf_id_t ctf_lookup_by_kind (ctf_dict_t *, int kind, const char *);
int ctf_type_conflicting (ctf_dict_t *, ctf_id_t, const **cuname);
...
ctf_member_f, ctf_visit_f gain int bit_width arg
