...
const struct aarch64_operand aarch64_operands[] =
{
  ...
  {AARCH64_OPND_CLASS_IMMEDIATE, "A64C_IMM6_EXT", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_a64c_shift, FLD_imm6_2}, "6-bit unsigned immediate"},
  ...
  {AARCH64_OPND_CLASS_ADDRESS, "CAPADDR_SIMM7", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_capaddr_simm7}, "a capability based address with 7-bit signed immediate offset"},
