...
/* The data structures used here are defined in the header file
   opcode/sparc.h.  If you change anything here, make sure you fix up that
   file, and vice versa.  */
...
/* This table must parallel the enumerator sparc_architecture in
   "opcode/sparc.h".  */
...
/* The order of the opcodes in the table is significant:
   ...
   This table currently cannot be made "const", because it gets sorted by
   code in sparc-pinsn.c.  If you want to change that, make sure both
   gdb and binutils get fixed!

   The definitions of the letters describing the parameter list can be
   found in opcode/sparc.h, as well as some of the macros used for
   constructing or examining the integer fields.
 */
